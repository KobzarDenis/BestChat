...
using Owin;
using WebAuthorizationServer.Models;
    ...
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.UseGoogleAuthentication(
                 clientId: "854276310419-oq150vknoa51vvhpi3ng4n0vp8e3kslg.apps.googleusercontent.com",
                 clientSecret: "rBtT4-mNxfvGqQvazH6Gfj7Z"
            );
        }
    }
}