...
namespace Chat
{
    class ServerCommands
    {
        ...
        {
            Content content = new Content("Authorization","*", login, password, ClientAPI.Role, "*", "*");
        ...
        {
            Content content = new Content("SignUP", name, login, password, ClientAPI.Role, "*",  "*");
            string message = content.GetContent(content);
            me.Say(message);
        }
        ...
        {
            Content content = new Content("ChangePassword", "*", ClientAPI.Login, "*", ClientAPI.Role, "*", newPass);
            string message = content.GetContent(content);
            me.Say(message);
        }
